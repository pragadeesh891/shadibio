...
const RegisterPage = () => {
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        'div',
        { className: 'glass py-10 px-6 shadow-2xl sm:rounded-3xl sm:px-10' },
        React.createElement(
          'form',
          ...
          React.createElement(
            ...
            React.createElement(
              'label',
              { htmlFor: 'name', className: 'block text-sm font-bold text-gray-700' },
              t('fullName')
            ),
            React.createElement(
              'div',
              ...
              React.createElement('input', {
                ...
                className: 'appearance-none block w-full px-4 py-3 bg-white/10 border border-white/20 rounded-xl shadow-sm text-white placeholder-white/50 focus:outline-none focus:ring-2 focus:ring-white/50 focus:border-transparent sm:text-sm transition-all'
              })
            )
          ),
          React.createElement(
          ...
          React.createElement(
            ...
            React.createElement(
              'label',
              { htmlFor: 'confirmPassword', className: 'block text-sm font-bold text-gray-700' },
              t('confirmPassword')
            ),
            React.createElement(
              'div',
